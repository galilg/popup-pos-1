...
**EXCEPT ENDPOINT:** **/1/reservation**,

which responds to multiple RESTful calls: **DELETE**, **GET**, and **POST**.
...
**AND ENDPOINTS: /1/reservation/find, /1/reservation/find/[location]**

These methods are respectively called:

- reservation_find_by_lat_long(lat, long, day[YYYY-MM-DD], num_seats)
- reservation_find_by_location(location_id, day[YYYY-MM-DD])

To post or delete reservations a 'resy_token' is required.

resy_tokens are returned by the methods:

- reservation_get(id, day[YYYY-MM-DD], num_seats) # For posting a new reservation
